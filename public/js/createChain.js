function getUrlParamHtml(key,value){
	return "<div class='col-sm-12'><div class='col-sm-2'><input required='true' type='text' class='form-control' id='formKey' name='urlParamKey' placeholder='form variable key' value='"+key+"'></div><div class='col-sm-4'><input required='true' type='text' class='form-control' id='formParamValue' name='urlParamValue' placeholder='Value' value='"+value+"'></div><div class='col-sm-1'><a onclick='removeThisParam(this)' href='javascript:void(0);' class='btn btn-link btn-xs' id='removeParam' on><span class='glyphicon glyphicon-remove'></span></a></div></div>";
}
function getUNPWDHtml(key,value){ 
	return "<div class='col-sm-2'><input required='true' type='text' class='form-control' id='formKey' name='basicAuthUserKey' placeholder='user name' value='"+key+"'></div><div class='col-sm-2'><input required='true' type='text' class='form-control' id='formParamValue' name='basicAuthPwd' placeholder='password' value="+value+"></div><div class='col-sm-1'><a onclick='removeThisParam(this)' href='javascript:void(0);' class='btn btn-link btn-xs' id='removeParam' on><span class='glyphicon glyphicon-remove'></span></a></div>";
	}
function getFormParamHtml(key,value){ return "<div class='col-sm-12'><div class='col-sm-2'><input value='"+key+"' required='true' type='text' class='form-control' id='formKey' name='paramKey' placeholder='form variable key'></div><div class='col-sm-4'><input value='"+value+"' required='true' type='text' class='form-control' id='formParamValue' name='paramValue' placeholder='Value'></div><div class='col-sm-1'><a onclick='removeThisParam(this)' href='javascript:void(0);' class='btn btn-link btn-xs' id='removeParam' on><span class='glyphicon glyphicon-remove'></span></a></div></div>";
}
function getHeaderHtml(key,value){ return "<div class='col-sm-12'><div class='col-sm-2'><input value='"+key+"' required='true' type='text' class='form-control' id='headerKey' name='headerKey' placeholder='Header variable key'></div><div class='col-sm-4'><input value='"+value+"' required='true' type='text' class='form-control' id='headerValue' name='headerValue' placeholder='Value'></div><div class='col-sm-1'><a onclick='removeThisParam(this)' href='javascript:void(0);' class='btn btn-link btn-xs' id='removeParam' on><span class='glyphicon glyphicon-remove'></span></a></div></div>";
}
function getBodyHtml(key){return "<div class='col-sm-12'><div class='col-sm-6'><textarea required='true' type='text' class='form-control' id='headerKey' name='jsonBody' placeholder='Header variable key'> "+key+"</textarea></div><div class='col-sm-1'><a onclick='removeBodyParam(this)' href='javascript:void(0);' class='btn btn-link btn-xs' id='removeParam' on><span class='glyphicon glyphicon-remove'></span></a></div></div>";
}

function getPostAddParamHtml(key,value){return "<div class='col-sm-12'><div class='col-sm-2'><input  value='"+key+"' required='true' type='text' class='form-control' id='headerKey' name='headerKey' placeholder='Header variable key'></div><div class='col-sm-4'><input value='"+value+"'  required='true' type='text' class='form-control' id='headerValue' name='headerValue' placeholder='Value'></div><div class='col-sm-1'><a onclick='removeThisParam(this)' href='javascript:void(0);' class='btn btn-link btn-xs' id='removeParam' on><span class='glyphicon glyphicon-remove'></span></a></div></div>";
}
...
function addElement(typeOfParam, linkTo) {
	...
	if (typeOfParam == 'headerparam') {
		...
		parent.append(getBodyHtml('',''));
		$(linkTo).addClass('disabled');
...
function removeElement(testcaseId, reqId) {
	$('#myPleaseWait').modal('show');
	$.get("/remove-unit-request/" + testcaseId + "/" + reqId, function(data,
			status) {
		$("#comp-app-" + reqId).remove();
		$('#myPleaseWait').modal('hide');
	}
, "html");
}
...
function addBasicRequest(reqId,requestType){
	$.get( "/testcase/add-component/"+$("#testCaseid").val()+"/"+reqId, function( data ) {
		  $("#request-chain-view").append(data);
...
function removeBodyParam(obj,id) {
	// alert("r u sure?");
	$("#unit-request-"+id).find("#addFormParamToPost").removeClass('disabled');
	$(obj).parent().parent().remove();
}
